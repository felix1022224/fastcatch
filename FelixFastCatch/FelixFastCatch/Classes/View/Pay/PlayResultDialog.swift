...
class PlayResultDialog: BaseDialog {
    ...
    override func createView() {
        ...
        successTitle.font = UIFont.systemFont(ofSize: CGFloat(20))
        ...
        successInfo.font = UIFont.systemFont(ofSize: CGFloat(12))
        ...
        errorTitle.font = UIFont.systemFont(ofSize: CGFloat(20))
