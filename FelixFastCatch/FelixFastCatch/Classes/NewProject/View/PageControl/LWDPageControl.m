...
- (void)initialize{
    ...
    _numberOfPages = 0;
    _currentPage = 0;
    _pageIndicatorColor = [UIColor colorWithRed:255/255.f green:255/255.f blue:255/255.f alpha:0.5f];
    _currentPageIndicatorColor = [UIColor colorWithRed:255/255.f green:255/255.f blue:255/255.f alpha:1.f];
    _indicatorWidth = 10.f; //普通宽度
    _indicatorMargin = 8.f; //间距
    _currentIndicatorWidth = 18.f;// 当前 宽度
    _indicatorHeight = 8;
}
