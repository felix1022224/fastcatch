...
//
//    /// 直播间内主播的ID列表
//    var liveBroadcastingIds:[UInt]?{
//        set{
//            if let newValue = newValue {
//                objc_setAssociatedObject(self, &liveKeys.ids, newValue, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
//            }
//        }
//        get{
//            return objc_getAssociatedObject(self, &liveKeys.ids) as? [UInt]
//        }
//    }
    /// 主摄像头Id
